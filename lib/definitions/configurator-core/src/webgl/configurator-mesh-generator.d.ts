...
export default class ConfiguratorMeshGenerator extends MeshGenerator {
    ...
    generateMesh(meshId: string, materialId: string, vertices: Int32Array, indices: Int32Array, uvCoords: Float32Array, normals: Float32Array, newGeometryInstance?: boolean): THREE.Mesh;
