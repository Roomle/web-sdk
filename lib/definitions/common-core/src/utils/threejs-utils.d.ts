...
export declare const DOCK_PREVIEW_MATERIAL_COLOR = "#DDDDDD";
export declare const DOCK_PREVIEW_MATERIAL_ROUGHNESS = 1;
export declare const DOCK_PREVIEW_MATERIAL_METALNESS = 0;
export declare const DOCK_PREVIEW_MATERIAL_OPACITY = 0.6;
...
export declare const addTexture: (assetUrl: string, rapiTexture: RapiTexture, material: import("three").MeshPhysicalMaterial, maxAnisotropy: number, repeatWidth: number, repeatHeight: number) => Promise<void>;
